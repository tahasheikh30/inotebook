    ...
    >
      <div className="signup-container">
        ...
        <form className="signup-form" onSubmit={handleSubmit}>
          ...
          <input value="Register" type="submit" className="signup-button" />
        </form>
        <div className="signup-social-account-container">
          <span className="signup-title" style={{ margin: "15px" }}>
            <strong>
              <h6>Or Sign up with</h6>
            </strong>
          </span>
          <div className="signup-social-accounts">
            ...
            <button className="signup-social-button signup-apple">
              <svg
                viewBox="0 0 384 512"
                height="1em"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <button className="signup-social-button signup-twitter">
              <svg
                viewBox="0 0 512 512"
                height="1em"
                xmlns="http://www.w3.org/2000/svg"
